  ...
  return (
    <div className="box-border bg-white sticky top-0 mb-5 z-30">
      <nav className="px-[20px] xl:px-[58px] flex items-center justify-between py-[10px] shadow-lg">
        ...
        {(router.asPath.includes("hangarlocation") || router.asPath.includes("hangardescription") || router.asPath.includes("hangardimension"))? null : (
        ...
        <div className="hamber-main relative right-0">
          <div onClick={()=>setOpen(!open)} className="button flex justify-center items-center">
            ...
            {router.asPath === "/hangarlocation" || router.asPath === "/hangardescription" || router.asPath === "/hangardimension" && (
              <button
