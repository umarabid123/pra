      ...
      <nav className="px-[20px] xl:px-[58px] flex items-center justify-between py-[10px] shadow-lg">
        <div className="nav-item-1">
          <svg
            ...
            viewBox="0 0 566 128"
            class="w-44 lg:w-[210px] fill-[#00aeef!important] !fill-primary hidden sm:block sm:w-[150px] pb-1 sm:py-2"
          >
            <g id="Layer_1">
        ...
        {(router.asPath.includes("hangarlocation") || router.asPath.includes("hangardescription") || router.asPath.includes("hangardimension") || router.asPath.includes("hangarcheckin") || router.asPath.includes("hangarprice") || router.asPath.includes("hangarfinish") || router.asPath.includes("hangarterms"))? null : (
        ...
        <div className="hamber-main relative right-0">
          <div className="button flex justify-center items-center">
            <div className="text hidden md:block px-3 py-1 hover:bg-gray-100 text-sm font-medium cursor-pointer">
              ...
              router.asPath.includes("hangarlocation") || router.asPath.includes("hangardescription") || router.asPath.includes("hangardimension") | router.asPath.includes("hangardescription") || router.asPath.includes("hangarcheckin") || router.asPath.includes("hangaraddimg") || router.asPath.includes("hangarprice") || router.asPath.includes("hangarfinish") || router.asPath.includes("hangarterms")? null : (
            ...
            {router.asPath === "/hangarlocation" || router.asPath === "/hangardescription" || router.asPath === "/hangardimension" || router.asPath === "/hangarcheckin" || router.asPath === "/hangaraddimg" || router.asPath === "/hangarprice" || router.asPath === "/hangarfinish" || router.asPath === "/hangarterms" && (
              <button
            ...
            <div  onClick={()=>setOpen(!open)} className="hamber flex items-center gap-2 p-[4px] border-[1px] border-gray-400 rounded-[9999px]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 ml-1"
                fill="none"
